...
\usepackage[backend=biber,
	...
	sorting=none, % list references in citation order, like [1], [2], ...
...
%	\begin{defbox}{title}
	...
	%	\end{defbox}
%%%%%%%%
% Base colour for the \texttt{defbox} environment (body + header)
% Change it in your main file with: \setdefboxbasecolor{<xcolor-name>}
\newcommand{\defboxbasecolor}{cyan}
\newcommand{\setdefboxbasecolor}[1]{\renewcommand{\defboxbasecolor}{#1}}

\newtcolorbox{defbox}[1]{%
	enhanced,
	attach boxed title to top 	left={xshift=5mm,yshift=-5mm,yshifttext=-5mm},
	colback=\defboxbasecolor!5!white,
	colframe=\defboxbasecolor!75!black,
	coltitle=\defboxbasecolor!80!black,
%	left=0mm,right=0mm,top=2mm,bottom=0mm,
	title={#1},
	fonttitle=\bfseries\large,
	fontupper=\color{\defboxbasecolor!65!white},
	boxed title style={colback=\defboxbasecolor!5!white,colframe=\defboxbasecolor!75!black},
	before upper={
		\beamercolorsinboxes{\defboxbasecolor}
	}
}%
